...
const HeaderOne: React.FC<HeaderProps> = ({ variant = "default" }) => {
                    ...
                    <div className="container">
                        <div className="cs_main_header_in">
                            <div className="cs_main_header_left">
                                ...
                                <Link href="/">
                                <h4 className={`m-0 ${isWhite ? "text-white" : ""}`}>Atlas</h4>
                                </Link>
                            </div>
                            <div className="cs_main_header_right">
                                <div className="cs_nav cs_medium">
                                    <MobileMenu active={active} navTitle={navTitle} isWhite={isWhite} openMobileMenu={openMobileMenu} />
                                    <span className={`cs_munu_toggle ${active ? "cs_toggle_active" : ""} ${isWhite ? "text-white" : ""}`} onClick={handleActive}><span></span></span>
                                </div>
                                <div className="cs_toolbox">
                                    <span className="cs_icon_btn">
                                        <span className={`cs_icon_btn_in ${isWhite ? "text-white" : ""}`} onClick={handleActive}>
                                            <span></span>
                                            <span></span>
                                            <span></span>
                                            <span></span>
